...
- (id) init
{
	if (self = [super init])
	{
		...
		NSDictionary *registeredDefaults = [[NSMutableDictionary alloc] init];
		[registeredDefaults setValue:[NSNumber numberWithInteger:600] forKey:@"HERefreshInterval"];
...
- (IBAction)showPreferences:(id)sender
{
	...
	{
		preferencesController = [[HEPreferencesWindowController alloc] init];
	}
...
/**
    ...
    store file.  This code uses a directory named "Helium" for
...
- (NSString *)applicationSupportDirectory {
    ...
    return [basePath stringByAppendingPathComponent:@"Helium"];
}
